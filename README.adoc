...
and distribute your container images. Note, since GKE is hosted on Google Cloud Platform, a small
cost may be associated with running this guide. See the official
